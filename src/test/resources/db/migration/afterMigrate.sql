...
INSERT INTO product (store_id, name, description, sku, price) VALUES (1, 'Product Three', 'Description of the product Three', 'CFX12', 115.29);
...
INSERT INTO product (store_id, name, description, sku, price) VALUES (1, 'Product Four', 'Description of the product Four', 'CFL12', 15.26);
INSERT INTO product (store_id, name, description, sku, price) VALUES (1, 'Product Five', 'Description of the product Five', 'CFC19', 11.24);
